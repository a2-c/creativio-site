...
<body id="all">
    ...
    <main>
        ...
        <!-- Hero Shot -->
        <div class="lehre-blob small-blob" id="lehre-blob">
            <div class="" style="padding: 0; text-align: center;">

                <svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1305.5 911.9" style="enable-background:new 0 0 1305.5 911.9;" xml:space="preserve">
                    <style type="text/css">
                        .st0 {
                            opacity: 0;
                        }
